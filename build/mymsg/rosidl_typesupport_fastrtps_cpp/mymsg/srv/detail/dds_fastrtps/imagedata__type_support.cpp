...
#include "mymsg/srv/detail/imagedata__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const mymsg::srv::Imagedata_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mymsg::srv::Imagedata_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Imagedata_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mymsg::srv::Imagedata_Request *>(
...
{
  return max_serialized_size_Imagedata_Request(full_bounded, 0);
}
...
static rosidl_message_type_support_t _Imagedata_Request__handle = {
...
{
  return &mymsg::srv::typesupport_fastrtps_cpp::_Imagedata_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const mymsg::srv::Imagedata_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mymsg::srv::Imagedata_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Imagedata_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mymsg::srv::Imagedata_Response *>(
...
{
  return max_serialized_size_Imagedata_Response(full_bounded, 0);
}
...
static rosidl_message_type_support_t _Imagedata_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
...
{
  return &mymsg::srv::typesupport_fastrtps_cpp::_Imagedata_Response__handle;
}
...
static rosidl_service_type_support_t _Imagedata__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
...
{
  return &mymsg::srv::typesupport_fastrtps_cpp::_Imagedata__handle;
}

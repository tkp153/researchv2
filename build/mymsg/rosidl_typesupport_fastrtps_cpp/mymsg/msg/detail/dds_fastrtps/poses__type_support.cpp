...
#include "mymsg/msg/detail/poses__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: poses
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        mymsg::msg::typesupport_fastrtps_cpp::max_serialized_size_Pose(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const mymsg::msg::Poses *>(
    untyped_ros_message);
...
{
  return &mymsg::msg::typesupport_fastrtps_cpp::_Poses__handle;
}

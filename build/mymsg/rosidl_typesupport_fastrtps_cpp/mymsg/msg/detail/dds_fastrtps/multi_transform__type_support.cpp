...
#include "mymsg/msg/detail/multi_transform__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: transforms
  {
    ...
    for (size_t i = 0; i < size; i++) {
      mymsg::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  mymsg::msg::MultiTransform & ros_message)
{
  // Member: transforms
  {
    ...
    for (size_t i = 0; i < size; i++) {
      mymsg::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: transforms
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        mymsg::msg::typesupport_fastrtps_cpp::get_serialized_size(
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mymsg
max_serialized_size_MultiTransform(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // Member: transforms
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        mymsg::msg::typesupport_fastrtps_cpp::max_serialized_size_Transform(
...
{
  auto typed_message =
    static_cast<const mymsg::msg::MultiTransform *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mymsg::msg::MultiTransform *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MultiTransform__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mymsg::msg::MultiTransform *>(
...
{
  return max_serialized_size_MultiTransform(full_bounded, 0);
}
...
{
  return &mymsg::msg::typesupport_fastrtps_cpp::_MultiTransform__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mymsg, msg, MultiTransform)() {
  return &mymsg::msg::typesupport_fastrtps_cpp::_MultiTransform__handle;
}

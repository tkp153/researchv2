...
#include "mymsg/msg/detail/poses__rosidl_typesupport_fastrtps_c.h"
...
#include "mymsg/msg/detail/pose__functions.h"  // poses
...
using _Poses__ros_msg_type = mymsg__msg__Poses;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: poses
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, mymsg, msg, Pose
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  // field.name poses
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mymsg__msg__Pose(
...
static uint32_t _Poses__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mymsg__msg__Poses(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mymsg
size_t max_serialized_size_mymsg__msg__Poses(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: poses
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_mymsg__msg__Pose(
        full_bounded, current_alignment);
    }
  }
  // member: id
...
{
  return max_serialized_size_mymsg__msg__Poses(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mymsg, msg, Poses)() {

  ...
  foreach(_tuple ${_exported_typesupport_libraries})
    ...
    if(NOT IS_ABSOLUTE "${_library}")
      ...
      if(NOT _lib)
        ...
        message(FATAL_ERROR "Package 'mymsg' exports the typesupport library '${_library}' which couldn't be found")
      elseif(NOT IS_ABSOLUTE "${_lib}")
        # the found library must be an absolute path
        message(FATAL_ERROR "Package 'mymsg' found the typesupport library '${_library}' at '${_lib}' which is not an absolute path")
      elseif(NOT EXISTS "${_lib}")
        # the found library must exist
        message(FATAL_ERROR "Package 'mymsg' found the typesupport library '${_lib}' which doesn't exist")
      else()
        list(APPEND mymsg_LIBRARIES${_suffix} ${_cfg} "${_lib}")
      endif()

    else()
      if(NOT EXISTS "${_library}")
        # the found library must exist
        message(WARNING "Package 'mymsg' exports the typesupport library '${_library}' which doesn't exist")
      else()
        list(APPEND mymsg_LIBRARIES${_suffix} "${_library}")
      endif()
    endif()
  endforeach()
endif()

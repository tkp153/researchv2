...
{
  return &::mymsg::msg::rosidl_typesupport_cpp::Pose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mymsg, msg, Pose)() {
  return get_message_type_support_handle<mymsg::msg::Pose>();
}

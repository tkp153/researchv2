...
{
  new (message_memory) mymsg::srv::Waypoints_Request(_init);
}

void Waypoints_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mymsg::srv::Waypoints_Request *>(message_memory);
  typed_message->~Waypoints_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Waypoints_Request_message_member_array[1] = {
  {
    "waypoints",  // name
    ...
    offsetof(mymsg::srv::Waypoints_Request, waypoints),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Waypoints_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(mymsg::srv::Waypoints_Request),
...
{
  return &::mymsg::srv::rosidl_typesupport_introspection_cpp::Waypoints_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mymsg, srv, Waypoints_Request)() {
  return &::mymsg::srv::rosidl_typesupport_introspection_cpp::Waypoints_Request_message_type_support_handle;
}
...
void Waypoints_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) mymsg::srv::Waypoints_Response(_init);
}

void Waypoints_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mymsg::srv::Waypoints_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Waypoints_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mymsg::srv::Waypoints_Response, complete),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Waypoints_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(mymsg::srv::Waypoints_Response),
...
{
  return &::mymsg::srv::rosidl_typesupport_introspection_cpp::Waypoints_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mymsg, srv, Waypoints_Response)() {
  return &::mymsg::srv::rosidl_typesupport_introspection_cpp::Waypoints_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Waypoints_service_members = {
  ...
  // see get_service_type_support_handle<mymsg::srv::Waypoints>()
...
get_service_type_support_handle<mymsg::srv::Waypoints>()
{
  ...
  auto service_type_support =
    &::mymsg::srv::rosidl_typesupport_introspection_cpp::Waypoints_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mymsg, srv, Waypoints)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<mymsg::srv::Waypoints>();
}

...
#define NODE_MAIN_LOGGER_NAME "urg_node_driver"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liburg_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<urg_node::UrgNode>";

...
#include "urg_node_msgs/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Status_type_support_symbol_names_t _Status_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, urg_node_msgs, msg, Status)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, urg_node_msgs, msg, Status)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_urg_node_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, urg_node_msgs, msg, Status)() {
  return &::urg_node_msgs::msg::rosidl_typesupport_c::Status_message_type_support_handle;
}

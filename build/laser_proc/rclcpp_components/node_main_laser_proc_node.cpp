...
#define NODE_MAIN_LOGGER_NAME "laser_proc_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblaser_proc_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<laser_proc::LaserProcComponent>";

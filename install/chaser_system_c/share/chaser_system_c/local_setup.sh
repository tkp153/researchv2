...
: ${AMENT_CURRENT_PREFIX:="/root/researchv2/install/chaser_system_c"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/chaser_system_c/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/chaser_system_c/environment/path.sh"

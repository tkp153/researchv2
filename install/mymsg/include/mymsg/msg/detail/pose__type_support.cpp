...
{
  new (message_memory) mymsg::msg::Pose(_init);
}

void Pose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mymsg::msg::Pose *>(message_memory);
  typed_message->~Pose();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pose_message_member_array[1] = {
  {
    ...
    offsetof(mymsg::msg::Pose, keypoints),  // bytes offset in struct
...
{
  return &::mymsg::msg::rosidl_typesupport_introspection_cpp::Pose_message_type_support_handle;
}

...
bool mymsg__msg__pose__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * mymsg__msg__pose__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool mymsg__msg__poses__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mymsg.msg._poses.Poses", full_classname_dest, 22) == 0);
  }
  mymsg__msg__Poses * ros_message = _ros_message;
  {  // header
  ...
  {  // poses
    ...
    if (!mymsg__msg__Pose__Sequence__init(&(ros_message->poses), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mymsg__msg__Pose__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mymsg__msg__Pose * dest = ros_message->poses.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mymsg__msg__pose__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * mymsg__msg__poses__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mymsg.msg._poses");
  ...
  {  // poses
    ...
    mymsg__msg__Pose * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->poses.data[i]);
      PyObject * pyitem = mymsg__msg__pose__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }

...
bool mymsg__msg__transform__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mymsg.msg._transform.Transform", full_classname_dest, 30) == 0);
  }
  mymsg__msg__Transform * ros_message = _ros_message;
  {  // transform
...
PyObject * mymsg__msg__transform__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mymsg.msg._transform");
